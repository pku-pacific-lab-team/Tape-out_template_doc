...
* **数字子系统**的流片模板位于：`/project/common/block_flow_[12|22]nm_v1/`
* **顶层模块**的流片模板位于：`/project/common/top_flow_[12|22]nm_v1/`

!!! tip "路径约定"
    本教程中出现的所有**相对路径**均以 `/project/common/block_flow_[12|22]nm_v1/` 或 `/project/common/top_flow_[12|22]nm_v1/` 作为根目录，我们称这个根目录为 `$ROOT`。
...
* [一、Linux 环境下 EDA 工具介绍](./0_eda.md)
* 二、前端设计
    * [1. 数字子系统的仿真](./1_simulation.md)
    * [2a. 数字子系统的逻辑综合（TSMC N22）](./2_submodule_synthesis_22nm.md)
    * [2b. 数字子系统的逻辑综合（TSMC N12）](./2_submodule_synthesis_12nm.md)
* 三、后端实现
    * [3a. 数字子系统的后端设计（TSMC N22）](./4_submodule_implementation_22nm.md)
    * [3b. 数字子系统的后端设计（TSMC N12）](./4_submodule_implementation_12nm.md)
    * [4. 顶层模块的后端设计](./5_io.md)
    * [5a. 模块物理验证](./6_lvs_drc_block.md)
    * [5b. 顶层物理验证](./6_lvs_drc_top.md)
    * [6. 拼版](./7_final_layout.md)
* 四、回片测试
    * [7. PCB绘制](./8_PCB.md)
    * [8. 封装](./9_package.md)
    * [9. 测试](./10_testing.md)
* 五、附录
    * [10. RISC-V CPU 调试](./11_cpu_debug.md)
    * [11. C 代码编译](./12_compiling.md)
    * [12. WSL](./13_wsl.md)
    * [13. FPGA 验证](./14_FPGA_verification.md)
    * [14. PDK 设置](./15_PDK_setup.md)
    * [15. Digital-CIM 使用规范](./DCIM_spec.md)
    * [16. SRAM IP 使用规范](./sram_ip.md)
    * [17. 系统集成](./system_integration.md)
    * [18. FPU 使用规范](./fpu_spec.md)
    * [19. 通过FPGA使用DRAM](./FPGA_DRAM.md)
    * [20. 静态时序分析与功耗分析](./sta_pwr.md)
