...
* [一、EDA 工具与环境背景](background/eda_tools_environment.md)
* 二、前端设计
    * 1. RTL 设计
        * [1a. Digital-CIM 使用规范](frontend/rtl_design/dcim_ip_spec.md)
        * [1b. SRAM IP 使用规范](frontend/rtl_design/sram_ip_spec.md)
        * [1c. FPU IP 使用规范](frontend/rtl_design/fpu_ip_spec.md)
        * [1d. 系统集成](frontend/rtl_design/system_integration.md)
    * [2. 数字子系统的仿真](frontend/simulation.md)
    * [3a. 数字子系统的逻辑综合（TSMC N22）](frontend/submodule_synthesis_22nm.md)
    * [3b. 数字子系统的逻辑综合（TSMC N12）](frontend/submodule_synthesis_12nm.md)
* 三、后端实现
...
* 五、附录
    ...
    * [21. Linux 环境与常用工具](appendix/linux_environment.md)
