...
<figure>
  <img src="../figs/sram_array.png" width=80%>
...
!!! danger "RAWL 配置"
    ...
    如果 RAWL 设置与默认设置**不同**，则必须能够在操作期间**动态更改** EMA 设置。
...
!!! danger "WABL 配置"
    ...
    如果 WABL 设置与默认设置**不同**，则必须能够在操作期间**动态更改** EMA 设置。
...
<figure>
  <img src="../figs/sram_read_timing.png" width=80%>
  <figcaption>SRAM Read-cycle Timing</figcaption>
</figure>

<figure>
  <img src="../figs/sram_write_timing.png" width=80%>
